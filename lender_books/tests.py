...
class TestBookModel(TestCase):
    def setUp(self):
        self.book = Book.objects.create(title='Feed the cat', author='Scruff McGruff', status='complete')
        Book.objects.create(title='War and Peace', author='Tolstoy', status='complete')
        Book.objects.create(title='Walden', author='Thoreau', status='complete')
...
class TestBookViews(TestCase):
    def setUp(self):
        ...
        self.book_one = Book.objects.create(title='War and Peace', author='Tolstoy', status='complete')
        self.book_two = Book.objects.create(title='Walden', author='Thoreau', status='complete')
